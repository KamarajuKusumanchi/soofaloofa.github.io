...
date: 2014/05/20 08:54:12
description: <t render="markdown">In this post we will look at how to reduce the amount of data transfer during a MapReduce job using a combiner.</t>
tags: 
  - app engine
  - mapreduce
  - python
